...
public class DirectionFinder {
    ...
    public DirectionFinder(DirectionFinderListener listener, String origin, String waypoint1, String waypoint2) {
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        String mode = "walking";
        return DISTANCE_MATRIX_DIRECTION_URL + "origin=" + urlOrigin + "&destination=" + urlDestination + "&waypoints=via:" + urlWayPoint1 + "|via:" + waypoint2 + "&mode=" + mode + "&units=metric" + "&key=" + GOOGLE_DIRECTION_API_KEY;
    }
